...
from config import email, password, device_id
...
cred = \
    credentials.Certificate('/home/pi/Projects/Licenta/py/river-tracker-295612-5b536a04d227.json'
                            )
...
def sendMails(distance_value):
    ...
    msg['Subject'] = 'Rivertracker alert: Device ' + str(device_id) \
        + ' is reporting abnormal readings! ' + str(distance_value) \
        + ' cm.'

    body = 'We detected that device # ' + str(device_id) \
        + ' is reporting abnormal readings: ' + str(distance_value) \
